...
/// the canvas, the inspector rail, the ledger rail and the status band, in one
/// frame off one fixture with no scripted input.
///
...
///
/// Light only, for the reason [`the_hover_crosshair_still_reaches_the_chart_pane`]
